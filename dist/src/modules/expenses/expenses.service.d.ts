...
export declare class ExpensesService {
    ...
    constructor(db: db, auditService: AuditService, awsService: AwsService, expenseSettingsService: ExpensesSettingsService, awsStorage: S3StorageService, pusher: PusherService, cache: CacheService, push: PushNotificationService);
    private tags;
