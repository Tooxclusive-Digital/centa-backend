...
export declare class CertificationsService {
    ...
    findOne(certificationId: string): Promise<{}>;
    update(certificationId: string, dto: UpdateCertificationDto, userId: string, ip: string): Promise<{
        id: string;
        employeeId: string;
        name: string;
        authority: string | null;
    ...
    remove(certificationId: string): Promise<{
        deleted: boolean;
        id: string;
    }>;
}
