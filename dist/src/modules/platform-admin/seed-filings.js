...
function filingDate(payrollMonth, rng) {
...
function reference(taxType, rng) {
...
async function main() {
    ...
    `);
        ...
        const chosen = [...pending]
            ...
            .slice(0, toFile);
        const byType = chosen.reduce((acc, r) => {
        ...
        for (const o of chosen) {
            ...
            await pool.query(`insert into tax_filings
         ...
         values ($1,$2,$3,$4,$5,'',$6,'completed',$7::timestamp,$7::timestamp,$7::timestamp)`, [
            ...
            written++;
            if (written % 100 === 0)
                console.log(`  ${written}/${chosen.length}…`);
        }
        console.log(`\n✅ Filed ${written}. To undo:`);
        console.log(`   delete from tax_filings where reference_number like 'FILE-%';`);
    }
    finally {
        await pool.end();
    }
...
//# sourceMappingURL=seed-filings.js.map