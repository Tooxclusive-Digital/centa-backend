...
export class EmployeesService {
  ...
  constructor(
    ...
    this.logger.setContext(EmployeesService.name);
  }
  ...
  // EmployeesService
  async getEmployeeCard(employeeId: string, companyId: string) {
    ...
    // time in position (uses effectiveDate / employmentStartDate)
