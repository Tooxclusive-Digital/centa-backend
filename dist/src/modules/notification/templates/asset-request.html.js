...
exports.assetRequestHtml = void 0;
const _layout_1 = require("./_layout");
const assetRequestHtml = ({ employeeName, companyName, statusTitle, statusMessage, assetType, purpose, urgency, notes, rejectionReason, remarks, actionUrl, actionText = 'View Request', logoUrl, }) => (0, _layout_1.layout)({
    ...
    body: (0, _layout_1.panel)(`
                  ...
                  <tr>
                    <td style="padding: 0 16px 16px 16px">
                      <table width="100%">
                        ${(0, _layout_1.detailRow)('Asset Type', assetType)}
                        ${(0, _layout_1.detailRow)('Purpose', purpose)}
                        ${(0, _layout_1.detailRow)('Urgency', urgency)}
                        ${notes ? (0, _layout_1.detailRow)('Notes', notes) : ''}
                        ${remarks ? (0, _layout_1.detailRow)('Remarks', remarks) : ''}
...
exports.assetRequestHtml = assetRequestHtml;
//# sourceMappingURL=asset-request.html.js.map