...
type Section = 'core' | 'profile' | 'history' | 'dependents' | 'certifications' | 'compensation' | 'finance' | 'leave' | 'attendance' | 'payslip';
...
export declare class EmployeesService {
    ...
    private safe;
    private assign;
    findBySections(employeeId: string, companyId: string, sections: Set<Section>, month?: string): Promise<EmployeeFullResponse>;
